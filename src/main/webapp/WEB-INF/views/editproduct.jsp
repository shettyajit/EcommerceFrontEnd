		...
		<div class="login">
			<div class="main-agileits">
				<div class="form-w3agile form1">
					<h3>Product Add</h3>
<%-- 					<c:url var="addprod" value="/productadmin/add"></c:url> --%>
					<form:form action="${contextPath}/addprod" modelAttribute="Product" method="post">
						...
						<div class="key">
							...
							<form:input type="text" path="product_name" />
							<div class="clearfix"></div>
						</div>
						...
						<div class="key">
							<i class="glyphicon glyphicon-asterisk" aria-hidden="true"></i>
							<form:input type="password" path="product_price"/>
							<div class="clearfix"></div>
						</div>
