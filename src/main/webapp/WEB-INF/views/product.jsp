	...
	<body>
		...
		<div class="container">
			...
			<div class="top-header">
				<div class="logo">
					<a href="index.html"><img src="${img}/logo.png" title="barndlogo" /></a>
				</div>
							...
							<div class="col-md-6 product-filter-grid1-brands-col2">
									<div class="producst-cate-grids">
										<div class="col-md-4 producst-cate-grid text-center">
											<h2>WOMAN</h2>
											<img class="r-img text-center img-responsive" src="${img}/img-w.jpg" title="name">
											<span><img src="${img}/objs1.png" title="name"></span>
											<h4>TOTAL</h4>
											<label>357 PRODUCTS</label>
											<a class="r-list-w" href="#"><img src="${img}/list-icon.png" title="list"></a>
										</div>
										<div class="col-md-4 producst-cate-grid text-center">
											<h2>MAN</h2>
											<img class="r-img text-center img-responsive" src="${img}/man-r-img.jpg" title="name">
											<span><img src="${img}/objs2.png" title="name"></span>
											<h4>TOTAL</h4>
											<label>357 PRODUCTS</label>
											<a class="r-list-w" href="#"><img src="${img}/list-icon.png" title="list"></a>
										</div>
										<div class="col-md-4 producst-cate-grid text-center">
											...
											<span><img src="${img}/objs3.png" title="name"></span>
											<h4>TOTAL</h4>
											<label>357 PRODUCTS</label>
											<a class="r-list-w" href="#"><img src="${img}/list-icon.png" title="list"></a>
										</div>
